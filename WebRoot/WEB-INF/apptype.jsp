...
<div class="struts">
  <div class="app_table">
  		<table width="100%">
  			<c:forEach items="${type_app_info}" var="app">
  			<tr>
 ...
 <c:if test="${pageNow-1>0}">
  <div class="shangyiye"><a href="${pageContext.request.contextPath}/apptype.do?flag=gototype&pageNow=${pageNow-1}&id=${temptype}">上一页</a></div>
  	</c:if>	
  		<div class="yema"><a href="${pageContext.request.contextPath}/apptype.do?flag=gototype&pageNow=1&id=${temptype}">首页</a></div>
  <c:if test="${pageNow<pageCount}">
  <div class="xiayiye"><a href="${pageContext.request.contextPath}/apptype.do?flag=gototype&pageNow=${pageNow+1}&id=${temptype}">下一页</a></div>
  </c:if>		
 </div>
</div>
